				...
				<div class="col-sm-9">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                        <div class="navbar-nav">
                           ...
                           <a class="nav-item nav-link last" href="contact.phpl"><img src="images/shop_icon.png"></a>
    	...
    	<div class="container">
			...
			<div class="col-sm-4">
    				<div class="best_shoes">
    					<p class="best_text"><?php echo $row['company'] ?> </p>
    					<div class="shoes_icon"><img src="<?php echo 'admin/'.$row['photo'];  ?>" height=250 width=250 ></div>
    					<div class="star_text">
    						<div class="left_part">
    							<ul>
