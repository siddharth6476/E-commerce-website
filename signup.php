...
<html lang="en">
   ...
   <div class="header_section header_main">
    ...
    <div class="collection_text">Signup </div>
    <div class="layout_padding contact_section">
    	<div class="container">
    		<h1 class="new_text"><strong>sign up</strong></h1>
    	</div>
                       ...
                       <div class="container">
                          ...
                          <form method="post" >
                            <div class="form-group">
                              <input type="text" class="email-bt" placeholder="usermame" name="username">
                            </div>
                            <!--update-->
                            ...
                            <div class="form-group">
                              <input type="text" class="email-bt" placeholder="phonenumber" name="phonenumber">
                            </div>
                            ...
                            <div class="form-group">
                             ...
                             <!--update end-->
                             <div class="send_btn">
                            <input  class="main_bt" Type="submit" value="signup" name="ok">
                             </div>
                            ...
                            <?php
                              ...
                              if(isset($_POST['ok']))
                              {
                                ...
                                $q="insert into user_details (id,username,email,phonenumber,password,city)values(Null,'".$_POST['username']."','".$_POST['email']."','".$_POST['phonenumber']."','".$_POST['password']."','".$_POST['city']."')";
                                $r=mysqli_query($con,$q);

                                if($r)
					                        {
						                        echo"<script>window.location='index.php'</script>";
                                    echo"<script>alert('sign up sccesfully:')</script>";
