                    ...
                    <div class="input_main">
                       ...
                       <?php
                            ...
                            <div class="form-group">
                              <input type="text" class="email-bt"  name="username" placeholder="Username" value="<?php if(isset($_COOKIE["userlogin"])) { echo $_COOKIE["userlogin"]; } ?>">
                            </div>
                            <!--update-->

                            
                            <div class="form-group">
                              <input type="text" class="email-bt"  name="password" placeholder="Password" value="<?php if(isset($_COOKIE["userpassword"])) { echo $_COOKIE["userpassword"]; } ?>">
                            </div>
