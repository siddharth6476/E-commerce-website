...
<html lang="en">
				...
				<div class="col-sm-9">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                        <div class="navbar-nav">
                           ...
                           <a class="nav-item nav-link" href="contact.php">changepass</a>
   ...
   <body class="main-layout">
       ...
       <center>
    <div class="collection_text">Admin Login</div>
    <div class="layout_padding contact_section">
    	<div class="container">
    		<h1 class="new_text"><strong></strong></h1>
    	</div>
                    ...
                    <div class="input_main">
                       ...
                       <?php
                               ...
                               if(isset($_POST['ok']))
                              {
                                ...
                                $q = "select * from user_details where username = '".$_POST['username']."' and password = '".$_POST['password']."' ";
                            ...
                            <div class="form-group">
                              <input type="text" class="email-bt"  name="username" value="<?php if(isset($_COOKIE["userlogin"])) { echo $_COOKIE["userlogin"]; } ?>">
                            </div>
                            <!--update-->

                            
                            <div class="form-group">
                              <input type="text" class="email-bt"  name="password" value="<?php if(isset($_COOKIE["userpassword"])) { echo $_COOKIE["userpassword"]; } ?>">
                            </div>

                            <div class="form-group">
                            <input type="checkbox" name="remember" id="remember" <?php if(isset($_COOKIE["userlogin"])) { ?> checked <?php } ?>" /> Remember Me
                            </div>
                             ...
                             <!--update end-->
                             <div class="send_btn">
                            <input  class="main_bt" Type="submit" value="login" name="ok">
                             </div>
                            <br>

                            <a href="signup.php" style="color:white">not ragiester signup</a>
