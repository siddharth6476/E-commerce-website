...
<table align="center" border="1" cellpadding="10" cellspacing="10">
					...
					<font size="+1" color="black">Welcome ,
						<?php
							...
							if(isset($_POST['ok']))
							{
								...
								$currentPass = "";
								$q="select password from admin_details where username='$username'";
								...
								if($currentPass==$cpassword)
								{
									...
									//echo"<script>alert('Current password is  Same')</script>";
									if($npassword==$conpassword)
									{
										//echo"<script>alert('new password and confirm password is same')</script>";
										$q="update admin_details set password='$conpassword' where username= '$username' ";
			...
			<tr>
				<td class="form-group"  align="left" valign="top">
					<font size="+1" color="black">Current password</font>
				</td>
				<td align="center" valign="top">
					<input  class="email-bt" type="password" name="cpass" placeholder="Current Password" size="50" />
				</td>
	  ...
	  <tr>
				...
				<td align="center" valign="top">
					<input  class="email-bt" type="password" name="newpass" placeholder="New Password" size="50" />
				</td>
	 ...
	 <tr>
				...
				<td align="center" valign="top">
					<input class="email-bt" type="password" name="confirmpass" placeholder="Current Password" size="50" />
				</td>
