...
<html lang="en">
   ...
   <div class="header_section header_main">
    ...
    <div class="collection_text">Admin Signup </div>
    <div class="layout_padding contact_section">
    	<div class="container">
    		<h1 class="new_text"><strong>Admin sign up</strong></h1>
    	</div>
                          ...
                          <form method="post" >
                            ...
                            <?php
                              ...
                              if(isset($_POST['ok']))
                              {
                                ...
                                $q="insert into admin_details (id,username,password)values(Null,'".$_POST['username']."','".$_POST['password']."')";
