...
<?php 
		...
		{	
			...
			$id = $_REQUEST['id'];
			$q="update product_details set product_name='".$_POST['productname']."',price='".$_POST['price']."',company='".$_POST['company']."',quantity='".$_POST['quantity']."',photo='$pic' where id='$id'";
			
			$r=mysqli_query($con,$q);

			if($r)
			{
				echo"<script>alert('updated  sccesfully)</script>";
			}
			else
			{
